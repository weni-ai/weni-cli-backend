...
## [1.14.1] - 2026-06-15
- feat: remove sentry sdk instrumentation from lambdas
...
## [1.11.0] - 2026-03-30
- feat: add weni agents evaluation integration

## [1.10.3] - 2026-03-19
- feat: add jwt token generation in weni run command

## [1.10.2] - 2026-03-18
- feat: return instance in rule template

## [1.10.1] - 2026-03-18
- feat: fix classes execution in lambda templates

## [1.10.0] - 2026-03-18
- feat: add traces return in agents templates

## [1.9.3] - 2026-01-22
- feat: Add constants in lambda_function
- fix: Incorrect channel name
...
- feat: Return events in lambda_handler
...
- fix: Update preprocessor output handling to parse JSON data
- fix: active agent custom rule class
