...
class ActiveAgentProcessor:
    ...
    def process(self, agent_key: str) -> BytesIO:  # noqa: PLR0915
        ...
        try:
            ...
            # preprocessor_zip = BytesIO(self.preprocessor)
            ...
            for rule_key, rule_content in self.rules.items():
                rule_path = temp_path / "rules" / rule_key
                rule_path.mkdir(exist_ok=True, parents=True)

                # Extract rule zip content
                rule_zip = BytesIO(rule_content)
                ...
                if requirements_path.exists():
                    packager.install_dependencies(requirements_path, f"rule_{rule_key}")
            ...
            replacements = {
                ...
                "official_rules_imports": "OFFICIAL_RULES_IMPORTS",
                "rule_instance_to_template": "RULE_INSTANCE_TO_TEMPLATE",
                "official_rules_instances": "OFFICIAL_RULES_INSTANCES"
            }
