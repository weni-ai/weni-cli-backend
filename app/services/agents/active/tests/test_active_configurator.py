...
def configurator(
    ...
    definition: dict[str, Any] = {"agents": {"agent1": {"pre-processing": {}}}}
...
async def test_configure_agents_success(
    ...
    expected_resource_model = ActiveAgentResourceModel(
        preprocessor=b"preprocessor_content",
        rules={"rule1": b"rule1_content"},
...
def test_push_to_gallery_exception(
    ...
    mock_logger.error.assert_called_once_with(
        "Error pushing agents to Gallery: Network Error", exc_info=True
    )
